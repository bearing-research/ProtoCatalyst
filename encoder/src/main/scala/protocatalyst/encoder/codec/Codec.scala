...
/** Codec for doing conversions between two representations. Matches Spark's Codec trait from
  * codecs.scala.
  *
  ...
  *
  * @tparam I
  *   input type (external representation, e.g., user's domain object)
  * @tparam O
  *   output type (internal representation, e.g., Array[Byte])
  */
