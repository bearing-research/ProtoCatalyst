      ...
      dataType match
        ...
        case ProtoType.ArrayType(elemType, _) =>
          val seq = value match
            ...
            case other         =>
              throw IllegalArgumentException(s"Expected array-like, got: ${other.getClass}")
      ...
      dataType match
        case ProtoType.StringType =>
          value match
            ...
            case other                =>
              throw IllegalArgumentException(s"Expected MockUTF8String, got: ${other.getClass}")
        ...
        case ProtoType.ArrayType(elemType, _) =>
          value match
            ...
            case other =>
              throw IllegalArgumentException(s"Expected MockArrayData, got: ${other.getClass}")
...
/** Mock UTF8String - simulates Spark's org.apache.spark.unsafe.types.UTF8String. In real Spark,
  * UTF8String stores strings as UTF-8 encoded bytes for efficiency.
  */
