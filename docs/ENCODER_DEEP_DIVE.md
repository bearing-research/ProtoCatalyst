...
### 7.1 Schema Derivation Benchmarks
...
- **Proto**: Encoder already exists (compile-time). The 0.1-0.9μs is just field access.
...
### 7.3 Deserialization Benchmarks
...
### 7.4 Why Serialization is Also Faster
...
### 7.5 Why We Don't Use Runtime Code Generation
...
1. **Already faster than Spark**: As shown above, ProtoCatalyst outperforms Spark 2.6-8.4x on serialization without codegen
...
### 7.6 Inline Type Specialization (Implemented)
